...
export default function Diachi({errors =null, register, dataTinh,handelOnChange, summary, control, diachiKhoitao, labelRequired, hidenfieldTinh, hidenfieldAp}) {
  ...
  const handleOnSelectChange=(e, item) =>{
    ...
    return (
      <>
          <CCol lg="6" xs="12" style={hidenfieldTinh}>
          ...
          <CCol lg="6" xs="12" style={hidenfieldAp}>
              <Controls.Input
                  label="Thôn/xóm........"
                  name={summary.ten_so_nha}
                  defaultValue={sonhahientai}
                  type="text"
                  style={{ fontWeight: "bold", color: "black" }}
                  register={register}
                  // error={errors[summary.ten_so_nha]}
