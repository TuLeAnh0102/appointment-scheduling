...
function ThongKeSoLuongPTTheoToKhaiVanTai() {
    ...
    const loadData = () => {
        setLoading(true)
        reportService.thongkesoluongpttheotokhaivantai(chotDichTe, moment(startDate).format(FORMAT_DATETIME), moment(endDate).format(FORMAT_DATETIME), loaiPhuongTien)
            .then((res) => {
...
export default ThongKeSoLuongPTTheoToKhaiVanTai;
