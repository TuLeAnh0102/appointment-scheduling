...
import { columns } from "../ThongKeTheoToKhaiVanTai/ObjectColumns1";
...
function ThongKeChiTietTheoToKhaiVanTai() {
    ...
    const loadData = () => {
        setLoading(true)
        reportService.thongkechitietpttheotokhaivantai(chotDichTe, moment(startDate).format(FORMAT_DATETIME), moment(endDate).format(FORMAT_DATETIME), loaiPhuongTien)
            .then((res) => {
...
export default ThongKeChiTietTheoToKhaiVanTai;
